...
The following section provides background literature on extreme values, outliers, and their significance in mining-related problems. Though the \gls{NMR} framework does not directly incorporate \gls{EVT}, the statistical foundation is presented for completeness.
