...
Where $\mathcal{D}$ is a domain of interest. The location vector $\mathbf{u}$ could be data or grid node locations. Next, consider a set of $M+1$ latent variables characterized by a Gaussian \gls{RF}:
\begin{equation}
