...
\begin{figure}[htb!]
    ...
    \begin{tikzpicture}[node distance=1.5cm, align=center]
        ...
        \tikzstyle{accept1Block} = [rectangle, rounded corners, minimum width=4cm, minimum height=1.0cm,text centered, draw=black]
        ...
        \draw [->] (accept1Block.west) -- ++(-0.75,0) node[midway, above] {\textbf{no}} coordinate(almostleft) |- (poolBlock.170);
