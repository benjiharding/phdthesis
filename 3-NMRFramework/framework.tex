...
\begin{figure}[htb!]
    ...
    \begin{tikzpicture}[node distance=1.5cm, align=center]
        ...
        \draw [->] (accept1Block.west) -- ++(-0.5,0) node[midway, above] {no} coordinate(almostleft) |- (poolBlock.170);
        ...
        \draw [->] (accept2Block.west) -- ++(-1.5,0) node[midway, above] {no} coordinate(almostleft) |-(poolBlock.190);
        ...
        \draw [->] (accept3Block.east) -- ++(1.0,0) node[midway, above] {no} coordinate(almostright) |- (poolBlock.east);
