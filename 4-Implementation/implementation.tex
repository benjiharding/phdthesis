...
\begin{figure}
    ...
    \end{subtable}
    \caption{Normal score variogram reproduction (a) in the major, minor and vertical directions, respectively, and the components of $\theta$ (b). PFI=permutation feature importance. }
    \label{}
\end{figure}
